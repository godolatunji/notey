...
class gsp_notey_userindex_gsp extends GroovyPage {
...
printHtmlPart(7)
expressionOut.print(createLink(uri: '/notes/create'))
printHtmlPart(8)
for( note in (result) ) {
printHtmlPart(9)
expressionOut.print(createLink(params: [id: note.id], uri: '/notes/show/'))
printHtmlPart(10)
