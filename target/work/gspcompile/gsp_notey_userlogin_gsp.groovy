...
class gsp_notey_userlogin_gsp extends GroovyPage {
...
printHtmlPart(5)
invokeTag('stylesheet','asset',14,['src':("signin.css")],-1)
printHtmlPart(6)
})
...
printHtmlPart(11)
expressionOut.print(createLink(uri: '/postLogin'))
printHtmlPart(12)
...
public static final long LAST_MODIFIED = 1425836609411L
